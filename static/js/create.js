...
//mouseover and mouseout in create page
function mOver(obj) {
    obj.innerHTML = "Thank You"
  }
  
  function mOut(obj) {
    obj.innerHTML = "Book An Appointment"
  }
...
function overallSubmit(){
 ...
 // form toogle onchange
 // javascripcode for selection in create your own
 const dropdown = document.getElementById("validationDefault");
